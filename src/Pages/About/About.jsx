      ...
      <section className="apple">
        <div className="banana2">
            ...
            <div className="pear">
              <div className="orange">
                ...
                <div className="text">
                  ...
                  Our focus is to empower leaders, support community development, and promote positive change.
                  Our mission is built on the belief that every individual has the potential to make a difference,
                  while we strive to create opportunities for growth, development, and positive impact in our communities through areas like:
                </div>
                ...
                {open && (
                  <ul className="grape">
                    <li>
                      <b>Education:</b> Providing quality education and personal growth opportunities to empower individuals and communities.
                    </li>
                    <li>
                      <b>Peace Building:</b> Promoting inclusivity and community cohesion through initiatives that promote understanding, tolerance, and mutual respect.
                    </li>
                    <li>
                      <b>Youth Empowerment:</b> Supporting young people in acquiring skills and being self-sustainable with opportunities that enable them to contribute to their communities.
                    </li>
                    <li>
                      <b>Humanitarian Aid:</b> Providing support to vulnerable individuals and communities in need, including emergency relief and long-term development programs.
                    </li>
                    <li>
                      <b>Social Cohesion:</b> Building strong, inclusive, and resilient communities by promoting a sense of belonging, trust, and cooperation among community members.
                    </li>
                    <li>
                      <b>Community Development:</b> Fostering sustainable development and improving the quality of life for communities through initiatives that promote economic growth, social justice, and community empowerment.
                    </li>
                    <li>
                      <b>Environmental Preservation:</b> Protecting and conserving the natural environment, promoting sustainable practices and mitigating the impact of climate change.
                    </li>
                    <li>
                      <b>Our Story:</b> ZOZAC Community was founded by Afuh Alfred Ngum, a visionary leader who overcame incredible adversity to drive positive change. Witnessing the struggles of vulnerable youths and the lack of opportunities for education, sustainable skills, and employment, he decided to take action starting in 2009 by opening a free recording studio, movie production house and a stage where young talents can showcase their talents as a young leader. In 2020 he founded ZOZAC and in 2022, we registered ZOZAC Community. The name "ZOZAC" is derived from our founder's created language, which means "Togetherness Is Strength." This reflects our core belief that collective efforts and commitment to a common goal are essential for creating lasting impact and driving positive change.
                    </li>
                    <li>
                      <b>Our Registration:</b> ZOZAC Community is legally registered under the Cameroon government with the headquarters in Tiko sub-division, Fako division, South West Region, Cameroon, West Africa. It operates in conformity with the prescription of Article 7 of Law No <span style={{ color: "green" }}>90/054 of 19/12/1990</span> relating to the creation and functioning of associations in Cameroon, with registration No: <span style={{ color: "green" }}>1165/G.37/C84/VOLI/SAAJP</span>. This registration demonstrates our commitment to transparency, accountability, and good governance.
                    </li>
                  </ul>
                )}
                ...
                <div className="text">
                  <p style={{ color: "green" }}>Mission:</p>
                  Empower individuals with self-awareness, discipline, and the willpower to lead themselves and others towards a positive destination built on trust.
                  <p style={{ color: "green" }}>Vision:</p>
                  Be the leading force transforming, educating, and empowering individuals, groups, and communities with knowledge to prepare for tomorrow and the next generation.
                  <p style={{ color: "green" }}>Motto:</p>
                  Creating innovative leaders for a better tomorrow.
                  <p style={{ color: "green" }}>Slogan:</p>
                  Togetherness is strength
                  <p style={{ color: "green" }}>Goal:</p>
          ...
          <div className="watermelon">
            <div className="plum">
              <figure className="cherry">
                <img src={img1} alt="Image 1 about" className="img" />
              </figure>
              <figure className="blueberry">
                <img src={img2} alt="Image 2 about" className="img" />
              </figure>
            </div>
          </div>
        </div>
